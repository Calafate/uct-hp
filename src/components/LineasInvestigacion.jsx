        ...
        <div >
          <div className="item-inv">
            <div className="text-inv text-start">
              <FontAwesomeIcon icon={faHeartPulse} size="5x" color="#4DD0E1" pull="left" fixedWidth/>
          ...
          <div className="item-inv">
            <div className="text-inv text-start">
              <FontAwesomeIcon icon={faPeopleArrows} size="5x" color="#4DD0E1" pull="left" fixedWidth/>
          ...
          <div className="item-inv">
            <div className="text-inv text-start">
              <FontAwesomeIcon icon={faDna} size="5x" color="#4DD0E1" pull="left" fixedWidth/>
          ...
          <div className="item-inv">
            <div className="text-inv text-start">
              <FontAwesomeIcon icon={faFlaskVial} size="5x" color="#4DD0E1" pull="left" fixedWidth/>
          ...
          <div className="item-inv">
            <div className="text-inv text-start">
              <FontAwesomeIcon icon={faViruses} size="5x" color="#4DD0E1" pull="left" fixedWidth/>
